...
:library: Asciidoctor 1.5.0-preview.7
:idprefix:
:numbered:
:imagesdir: images
:toc:
...
.Drag your file !
****
You can drag your own file in the editor zone !
****

[role='lead']
This is a demonstration of {library} with *Asciidoctor.js*. And this is the preamble of this document.
